...
namespace Week4DoublyLinkedLists.Core
{
    ...
    public class DoublyLinkedList<T> : IEnumerable<T>
    {
        ...
        public T RemoveFirst()
        {
            ...
            if (IsEmpty){
                throw new InvalidOperationException("List is empty. Cannot remove first element.");
            }
        ...
        public T RemoveLast()
        {
            ...
            if (IsEmpty)
            {
                throw new InvalidOperationException("List is empty. Cannot remove last element.");
            }
        ...
        private Node<T> GetNodeAt(int index)
        {
            ...
            // At this point index is valid (0 <= index < count) so list is non-empty
            Node<T> current;
            if (index < count / 2)
            {
                current = head!; // non-null because count > 0
            ...
            {
                current = tail!; // non-null because count > 0
