...
namespace Assignment5
{
    ...
    public class BrowserSession
    {
        ...
        public void DisplayBackHistory()
        {
            ...
            if (BackHistoryCount > 0)
            {
                Console.WriteLine("https://www.google.com");
                Console.WriteLine("https://www.github.com");
                Console.WriteLine("https://stackoverflow.com");
            }
            else
            {
                Console.WriteLine("No Back History");
                foreach(var backStackLink in backStack)
                {
                    Console.WriteLine(backStackLink);
                }
            }
        }
        /// <summary>
        ...
        public void DisplayForwardHistory()
        {
            ...
            {
                foreach (var loop in forwardStack)
                {
        ...
        public void ClearHistory()
        {
            ...
            backStack.Clear();
            forwardStack.Clear();
            Console.WriteLine("Both back and forward clearing successful.");
        }
    }
}